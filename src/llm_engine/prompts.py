...
1. **Exhaustividad (Prioridad Alta)**: Incluye diagnóstico principal o sospecha actual, antecedentes oncológicos (tipo de cáncer, estadio, tratamiento previo/actual), cirugías o intervenciones previas relevantes, fechas cronológicas clave y síntomas que justifican el estudio.
2. **Especialidades y Rol del Autor**: Conserva la especialidad médica solicitante (ej. Oncología, Cirugía Digestiva, Urología) y especifica si la nota fue redactada por un residente (MIR / R1-R5) o médico adjunto/especialista cuando conste.
3. **Facticidad (Sin Alucinaciones)**: Basate EXCLUSIVAMENTE en la información proporcionada en las notas. No inventes antecedentes, fechas ni detalles clínicos. Si no consta en el texto, no lo asumas.
4. **Concisión y Estructura**: Genera un resumen telegráfico, claro y directo, listo para leer en 15 segundos antes o durante la interpretación del estudio radiológico.
